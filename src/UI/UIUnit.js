...
let PressureUnits = [ { name: `Bar`, SIMultiplier: 1, SIOffset: 0 }, { name: `kPa`, SIMultiplier: 100, SIOffset: 0 } ]
let AngularSpeedUnits = [ { name: `RPM`, SIMultiplier: 1, SIOffset: 0 } ]
let SpeedUnits = [ { name: `KPH`, SIMultiplier: 1, SIOffset: 0 }, { name: `MPH`, SIMultiplier: 1.61, SIOffset: 0 } ]
